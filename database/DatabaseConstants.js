...
const SQL_REMOVE_TOKENS_OLDER_PARAM_TIMESTAMP = '$deleteDateParam'
const SQL_REMOVE_TOKENS_OLDER = `
DELETE FROM ${TOKENS_TABLE_NAME}
WHERE ${COLUMN_TOKENS_TIMESTAMP} < ${SQL_REMOVE_TOKENS_OLDER_PARAM_TIMESTAMP}
`

const SQL_GET_LAST_TOKEN = `
SELECT * FROM ${TOKENS_TABLE_NAME}
ORDER BY ${COLUMN_TOKENS_TIMESTAMP} DESC
LIMIT 1`
...
module.exports = {
	...
	SQL_REMOVE_TOKENS_OLDER,
	SQL_REMOVE_TOKENS_OLDER_PARAM_TIMESTAMP,
